...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(200, 390, 89, 25))
        self.pushButton_2.setObjectName("pushButton_2")
        self.label_8 = QtWidgets.QLabel(Form)
        self.label_8.setGeometry(QtCore.QRect(400, 190, 131, 17))
        self.label_8.setObjectName("label_8")
        self.pushButton = QtWidgets.QPushButton(Form)
        self.pushButton.setGeometry(QtCore.QRect(390, 320, 89, 25))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_3 = QtWidgets.QPushButton(Form)
        self.pushButton_3.setGeometry(QtCore.QRect(420, 390, 89, 25))
        ...
        self.lineEdit_6.setGeometry(QtCore.QRect(170, 320, 191, 25))
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_2.setText(_translate("Form", "Register Employee"))
        self.label_4.setText(_translate("Form", "Last Name"))
        self.label_5.setText(_translate("Form", "Password"))
        self.lineEdit_3.setText(_translate("Form", "Register Employee"))
        ...
        self.lineEdit_4.setText(_translate("Form", "Register Employee"))
        self.label_9.setText(_translate("Form", "Email"))
        self.lineEdit_6.setText(_translate("Form", "Register Employee"))
        self.lineEdit_5.setText(_translate("Form", "Register Employee"))
        self.lineEdit_7.setText(_translate("Form", "Register Employee"))
        self.label_2.setText(_translate("Form", "User Type"))
        self.label_7.setText(_translate("Form", "Phone"))
        self.lineEdit_8.setText(_translate("Form", "Register Employee"))
        self.label_10.setText(_translate("Form", "Address"))
        self.lineEdit_9.setText(_translate("Form", "Register Employee"))
        self.label_11.setText(_translate("Form", "City"))
        self.lineEdit_10.setText(_translate("Form", "Register Employee"))
        self.label_12.setText(_translate("Form", "State"))
        self.label_13.setText(_translate("Form", "Zipcode"))
        self.lineEdit_11.setText(_translate("Form", "Register Employee"))
